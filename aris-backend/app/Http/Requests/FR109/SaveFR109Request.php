...
class SaveFR109Request extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data.chiefAccountingOfficerRefNo' => ['nullable', 'string', 'max:255'],
            'data.chiefSecretaryToMinistryOf' => ['nullable', 'string', 'max:255'],
            'data.chiefSecretaryRefNo' => ['nullable', 'string', 'max:255'],
