...
class FR1044Policy
{
    ...
    public function view(User $user, FR1044 $fr1044): bool
    {
        return $this->canAccessCase($user, $fr1044->accidentCase);
    }
    ...
    public function update(User $user, FR1044 $fr1044): bool
    {
        return $fr1044->created_by === $user->id
            && in_array($fr1044->status, ['DRAFT', 'CHANGES_REQUESTED'], true);
    }

    public function submit(User $user, FR1044 $fr1044): bool
    {
        return $fr1044->created_by === $user->id
            && $fr1044->status === 'DRAFT';
    }

    /** Attachments may only be changed by the draft owner. */
    public function attach(User $user, FR1044 $fr1044): bool
    {
        return $fr1044->created_by === $user->id
            && $fr1044->status === 'DRAFT';
    }
