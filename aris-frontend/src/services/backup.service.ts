...
import type { Backup, BackupFilters, BackupPage, BackupStatusSummary } from "@/types/backup.type";
...
export const backupService = {
  ...
  async restore(id: number): Promise<void> { await api.post(`/admin/backups/${id}/restore`, { confirmation: "RESTORE" }); },
